        ...
        <!-- Top bar -->
            <div class="row" id="top-bar">
                ...
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 col-lg-offset-4 col-md-offset-4 col-sm-offset-4 col-xs-offset-4" style="padding: 0">
                    <?php 
                    if ($this->params->get("phoneNumber")) : ?>        
                        <span class="fa fa-phone fa-lg" style="margin-right: 10px"></span>
                        <?php
                        echo $this->params->get('phoneNumber');
                    endif; 
                    ?>
                </div>
            ...
            <nav>
                <div class="row" id="nav-bar">
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                        ...
                        <ul>
                            <li>
                                <a href="https://vk.com" class="socials" target="_blank" data-toggle="tooltip" data-placement="bottom" title="Мы в VK">
                                    <span class="fa-stack">
                            ...
                            <li>
                                <a href="https://instagram.com" class="socials" target="_blank" data-toggle="tooltip" data-placement="bottom" title="Мы в Instagram">
                                    <span class="fa-stack">
                                        <i class="fa fa-circle fa-stack-2x"></i>
                            ...
                            <li>
                                <a href="https://facebook.com" class="socials" target="_blank" data-toggle="tooltip" data-placement="bottom" data-placement="bottom" title="Мы в Facebook">
                                    <span class="fa-stack">
                                        <i class="fa fa-circle fa-stack-2x"></i>
                            ...
                            <li>
                                <a href="https://ok.ru" class="socials" target="_blank" data-toggle="tooltip" data-placement="bottom" title="Мы в Однокассниках">
                                    <span class="fa-stack">
                                        <i class="fa fa-circle fa-stack-2x"></i>
                                    ...
                                    <div class="slide-caption">
                                       <span class="fa-stack icon">
                                        ...
                                        <span style="font-size: 77%">
                                            Сделайте заказ и каждый день Вы будете наслаждаться уникальным блюдом, получая удовольствие от процесса приготовления!
                                        </span>
                                   </div>
                                </div>
                            </div>
            ...
            <div class="row" id="footer">
                ...
                <div class="<?php echo $classFooter_3 ?>">
                    ...
                    <p>© 2016 Все права защищены.<br>
                        Сервис доставки продуктовых корзин EASY LIFE
                    </p>
                    -->
                </div>
                <!-- Button Hide Footer -->
